...
Route::prefix('apps')->group(function() {
    ...
    Route::group(['middleware' => ['auth']], function () {
        ...
        //route profits export excel
        Route::get('/profits/export', [App\Http\Controllers\Apps\SaleController::class, 'export'])->name('apps.profits.export');
        
        //route profits pdf
        Route::get('/profits/pdf', [App\Http\Controllers\Apps\SaleController::class, 'pdf'])->name('apps.profits.pdf');
